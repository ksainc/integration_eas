...
class EasXmlDecoder{
    ...
    private static $_codes = [
		...
		0x07 => [
			...
			0x11 => 'Update',
			0x12 => 'SyncKey',
			0x13 => 'CollectionCreate',
			0x14 => 'CollectionDelete',
			0x15 => 'CollectionUpdate',
			0x16 => 'CollectionSync',
			0x17 => 'Count',
			0x18 => 'Version',
		],
		...
		0x14 => [
			...
			0x10 => 'Schema',
			0x11 => 'Part',
			0x12 => 'EmptyCollectionContent',
			0x13 => 'DeleteSubCollections',
			// EAS 12.1
			0x14 => 'UserName',
			0x15 => 'Password',
			// EAS 14.0
