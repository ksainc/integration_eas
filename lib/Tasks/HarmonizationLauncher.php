    ...
    protected function run($arguments) {
        ...
        if ($this->ConfigurationService->getHarmonizationMode() == 'A') {
            try {
                ...
                $logger->error("Harmonization launcher encountered an error while starting a thread for $uid", ['app' => 'integration_eas', 'exception' => $e]);
            } catch (\Exception $e) {
                $logger->error("Harmonization launcher encountered an error while starting a thread for $uid", ['app' => 'integration_eas', 'exception' => $e]);
            }
        }
        // passive mode
            ...
            try {
                ...
                $logger->error("Harmonization launcher encountered an error while harmonizing for $uid", ['app' => 'integration_eas', 'exception' => $e]);
            } catch (\Exception $e) {
                $logger->error("Harmonization launcher encountered an error while harmonizing for $uid", ['app' => 'integration_eas', 'exception' => $e]);
            }
        } 
